...
KEYMAPS(
  ...
  (
    ...
    ,Key_KeypadEnter ,Key_KeypadEquals ,Key_Keypad1 ,Key_Keypad2 ,Key_Keypad3 ,Key_KeypadDot
    ,___ ,___ ,Key_Keypad0 ,___ ,___ ,___
  ),
  ...
  (
    ...
    ,Key_1 ,Key_2 ,Key_3 ,Key_4 ,Key_5 ,Key_Equals 
    ,___ ,___ ,___ ,Key_Escape ,___ ,Key_Minus

    ,Key_PageUp ,Key_Home ,Key_UpArrow ,Key_End ,Key_Insert
    ,Key_PageDown ,Key_LeftArrow ,Key_DownArrow  ,Key_RightArrow ,Key_Delete
    ,Consumer_VolumeIncrement ,XXX ,Consumer_ScanPreviousTrack ,Consumer_PlaySlashPause ,Consumer_ScanNextTrack ,XXX
    ,Consumer_VolumeDecrement ,___ ,___ ,___ ,___ ,___
  )
)
/* *INDENT-ON* */
